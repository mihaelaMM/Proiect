...
public class PatientServiceImpl implements PatientService {
    ...
    @Autowired
    private PatientRepository patientRepository; //dependency injection
...
/*
    @Override
    public List<Patient> findAllPatientWithAge(Long patientAge) {
        return patientRepository.findAllByPatientAge(patientAge);
    }
    */
}
